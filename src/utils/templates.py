...
def initial_location_template(quantity: int, tropes: list, themes: list) -> str:
    ...
    user_message = (f"Create {quantity} location/s with a name and a description of the area. The "
                    ...
                    f"tropes of {tropes} and the themes of {themes}. Return this in JSON format. "
...
def flow_on_location_template(quantity: int,
                              prev_location_name: str, tropes: list, themes: list) -> str:
    ...
    user_message = (f"Create {quantity} location/s with a name and a description of the area. The "
                    ...
                    f"the themes of {themes}. Return this in JSON format. Following this format as "
