...
def flow_on_choices_template(quantity: int, tropes: list, theme: str, key_events: list,
    ...
    user_message = (f"Generate {quantity} choices our player can take that make sense for the current pacing of the "
                    ...
                    f"actions_performed is a list of chosen actions within the choice. The actions within this list must have values the values be not None in the response."
                    f"Make sure that there is every action explained in the description."
